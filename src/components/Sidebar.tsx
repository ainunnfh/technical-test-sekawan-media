    ...
    <div className="w-full h-full">
      <div className="flex flex-no-wrap">
        <div
          ...
          className="w-64 min-h-screen absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex"
        >
          <div className="px-8">
            <div className="h-16 w-full flex items-center">
              <div className="flex items-center px-6 py-2 mt-4 text-gray-300 bg-opacity-25">
                <svg
                  className="w-6 h-6"
                ...
                <span className="m-1 text-gray-300 font-semibold">Dashboard Kit</span>
              </div>
            </div>
            <ul className="mt-12">
              ...
              <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                ...
                >
                  ...
                  <span className="text-sm ml-2">Tickets</span>
                </a>
                <div className="py-1 px-3 bg-gray-600 rounded text-gray-300 flex items-center justify-center text-xs">
                  8
                </div>
              ...
              <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                ...
                >
                  ...
                  <span className="text-sm ml-2">Ideas</span>
                </a>
              </li>
              <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                <a
              ...
              <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                ...
                >
                  ...
                  <span className="text-sm ml-2">Agents</span>
                </a>
                <div className="py-1 px-3 bg-gray-600 rounded text-gray-300 flex items-center justify-center text-xs">
                  25
                </div>
            ...
            <ul className="mt-12">
              ...
              <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center">
                ...
                >
                  ...
                  <span className="text-sm ml-2">Subscriptiossns</span>
                </a>
              </li>
            </ul>
          </div>
